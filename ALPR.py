...
img=cv2.imread('F:\MAJOR PROJECT\code exceution\Preprocessing Step\car19.jpg',1) #Reading an Image
size=(1000,600)
...
ret,thresh1 = cv2.threshold(differenceimage,125,255,cv2.THRESH_BINARY)  
...
sobel = cv2.Canny(thresh1,100,200)
...
for i in range(len(stats)):
    ...
    cv2.imshow('license plate image',img3)
    cv2.imwrite('F:\MAJOR PROJECT\code exceution\Preprocessing Step\out.jpg',img3)
    #plt.imshow(img4) 
    #plt.show()
